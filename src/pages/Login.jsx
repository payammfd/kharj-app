      ...
      <div className={s.content}>
        ...
        <div className={s.features}>
          <div className={s.feature}>
            ...
            <span>مدیریت کارت‌های بانکی</span>
          </div>
          <div className={s.feature}>
            <span className={s.featureIcon}>👨‍👩‍👧</span>
            <span>اشتراک‌گذاری با خانواده</span>
          </div>
          <div className={s.feature}>
            <span className={s.featureIcon}>📊</span>
            <span>آمار و نمودار ماهانه</span>
          </div>
        </div>
        ...
        <p className={s.hint}>با ورود، حساب کاربری شما ساخته یا وارد می‌شید</p>
      </div>
    </div>
  )
}
