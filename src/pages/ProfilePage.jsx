...
export default function ProfilePage() {
  ...
  const { plan, members, loadPlan } = usePlan()
  ...
  return (
    <div className={s.page}>
      ...
      <div className={s.avatarSec}>
        ...
        <p className={s.avatarHint}>برای تغییر عکس پروفایل کلیک کن</p>
      </div>

      <div className={s.fields}>
        <div className={s.field}>
          <label className={s.lbl}>اسم نمایشی</label>
          <input value={displayName} onChange={e=>setDisplayName(e.target.value)} placeholder="اسمت رو وارد کن"/>
        </div>
        <div className={s.field}>
          <label className={s.lbl}>ایمیل</label>
